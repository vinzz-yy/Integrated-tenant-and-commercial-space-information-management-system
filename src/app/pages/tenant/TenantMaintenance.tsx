...
// Tenant Maintenance APIs:
// - GET /api/maintenance/requests/?tenant_id={user.id} - Get tenant's maintenance requests
// - POST /api/maintenance/requests/ - Submit new maintenance request (FormData with optional files)

export function TenantMaintenance() {
  const { user } = useAuth();
  const navigate = useNavigate();
  const [requests] = useState(mockMaintenanceRequests.filter(req => req.tenantId === user?.id));
  ...
  const handleSubmitRequest = () => {
    // DJANGO BACKEND INTEGRATION POINT
    // API Call: POST /api/maintenance/requests/
    // const formDataToSend = new FormData();
    // formDataToSend.append('title', formData.title);
    // formDataToSend.append('description', formData.description);
    // formDataToSend.append('priority', formData.priority);
    // formDataToSend.append('tenant_id', user.id);
    // formDataToSend.append('unit_number', user.unitNumber);
