...
import { Camera, User, Mail, Phone, Building, Save, X } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent className="space-y-6">
                ...
                {/* Unit Number - read only, preserved from first code */}
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <Label htmlFor="unitNumber" className="text-[#2E3192] font-medium flex items-center gap-2 mb-2">
                    <Building className="h-4 w-4" />
                    Assigned Unit
                  </Label>
                  <Input 
                    id="unitNumber"
                    value={user?.unitNumber || 'Not assigned'} 
                    disabled 
                    className="bg-white"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Contact administration to change your unit assignment
                  </p>
                </div>
