...
import { Camera, User, Mail, Phone, Building, Save, X, Settings, Lock } from 'lucide-react';
            ...
            <Card className="lg:col-span-2 border-2 border-transparent hover:border-[#F9E81B] transition-colors">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="tn-currentPassword" title="Current Password" className="text-[#2E3192] font-medium flex items-center gap-2">
                        Current Password
                      </Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="tn-newPassword" title="New Password" className="text-[#2E3192] font-medium flex items-center gap-2">
                        New Password
                      </Label>
                      <Input
                        id="tn-newPassword"
